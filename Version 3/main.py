...
import Graphs  # Graphs.py in repo
...
class PFM(tk.Tk):
    ...
    def searchPage(
        ...
        groupNeeded = tk.Label(self.searchRemoveFrame, text="*Note: Must enter an expense group to proceed",
                               font=("Times New Roman", 12), bg="midnightblue")
    ...
    def viewPage(self):
        ...
        def displayGraph():
            ...
            group = self.trees[graphGroupChoice].newSearch(self.trees[graphGroupChoice].root,
                                                           self.trees[graphGroupChoice].name, None, None, None, [])
